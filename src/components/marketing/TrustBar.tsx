...
export function TrustBar({ locale }: { locale: Locale }) {
  return (
    <div className="relative z-20 -mt-8 rounded-[28px] border border-black/[0.06] bg-white/90 px-5 py-5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] backdrop-blur-2xl sm:-mt-10">
