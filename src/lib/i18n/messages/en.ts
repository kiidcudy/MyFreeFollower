export const en = {
  ...
  catalog: {
    ...
    usernameLabel: "Username or link",
    usernamePlaceholder: "https://... or @username",
    usernameHint: "We never ask for your password. Every order is safe and secure.",
    checkLink: "Check",
    linkVerified: "Link verified",
    linkCheckFailed: "Enter a valid username or profile URL.",
    customAmountLabel: "Or enter a custom amount",
    customAmountPlaceholder: "e.g. 2500",
    customAmountRange: "Min {min} — Max {max}",
    totalToPay: "Total to pay",
    unitPrice: "{price} / item",
    estimatedStart: "Estimated start",
    guestCheckout: "No account needed — guest checkout available.",
    securePayment: "Secure payment",
    instantDelivery: "Instant delivery",
    noPasswordNeeded: "No password needed",
    noMembershipRequired: "No membership required to buy",
  ...
  cart: {
    ...
    payOrderTitle: "Complete payment",
    payOrderHint: "Pay with Binance Pay. Card and Cryptomus coming soon.",
    payBinance: "Pay with Binance Pay",
    payCrypto: "Pay with Cryptomus",
    payCard: "Pay with Credit / Debit Card",
    comingSoon: "Coming soon",
    backToCart: "Back to cart",
    guestCheckout: "Guest checkout — enter your email for order updates.",
    emailRequired: "Enter a valid email to continue.",
    checkoutOrderNumber: "Reference",
    paymentPendingOrder: "Waiting for payment confirmation…",
    successTitle: "Order received",
    successText: "We received your payment request. Orders are processed after confirmation — support will contact you if needed.",
    binanceStepPay: "Make payment",
    binanceStepVerify: "Payment submitted",
    binanceSendToId: "Send to Binance ID",
    binanceNickname: "Nickname",
    binanceCopy: "Copy",
    binanceCopied: "Copied",
    binanceScanTitle: "Scan with Binance App to pay",
    binanceUidLabel: "UID",
    binanceInstruction1: "Scan the QR using the Binance app or send USDT to the Binance ID with the exact amount shown.",
    binanceInstruction2: "After completing the payment tap 'Confirm payment'.",
    binanceConfirmPayment: "Confirm payment",
    binanceOrderNumber: "Reference",
    binanceVerifyHint: "Your payment is being verified. We will process your order after confirmation.",
    binanceClose: "Close",
  },
  admin: {
    title: "Admin Panel",
