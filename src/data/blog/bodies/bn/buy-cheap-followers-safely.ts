...
export const buyCheapFollowersSafely: BlogBodyOverride = {
  sections: [
    ...
    { h2: "Hybrid বাজেট", body: `[ফ্রি ফলোয়ার](/free-followers), [লাইক](/free-followers/free-instagram-likes), [Instagram কিনুন](/buy-followers/buy-instagram-followers)।` },
    { h2: "টিম flow", body: `Password-free demo, order notes।` },
    { h2: "Supplier scorecard", body: `Re-test [ফ্রি](/free-followers)।` },
    { h2: "Refund/support", body: `Order ID escalate।` },
  ],
  faq: [
    { q: "সস্তা ফলোয়ার কেনা legal?", a: "সাধারণত হ্যাঁ; platform terms সীমা দিতে পারে।" },
    { q: "নিরাপদ পেমেন্ট?", a: "Verified panel checkout।" },
    { q: "একবারে কত?", a: "নতুন: শ hundreds, not tens of thousands।" },
    { q: "trial পর?", a: "retention ভালো হলে upgrade।" },
    { q: "engage করে?", a: "মূলত social proof।" },
  ],
};
