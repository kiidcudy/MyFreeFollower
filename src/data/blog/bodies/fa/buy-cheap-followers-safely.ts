...
export const buyCheapFollowersSafely: BlogBodyOverride = {
  sections: [
    ...
    { h2: "بودجه hybrid", body: `تسک + [فالوور رایگان](/free-followers) + paid. هفته 3 [لایک](/free-followers/free-instagram-likes) + [فالوور](/free-followers/free-instagram-followers).` },
    { h2: "جریان تیم", body: `یادداشت order: campaign، تاریخ. demo بدون رمز قبل از retainer.` },
    { h2: "scorecard supplier", body: `امتیاز 1–5: speed، retention. re-test [رایگان](/free-followers).` },
    { h2: "refund و support", body: `Escalate با order ID. chargeback بدون contact refill از دست می‌دهد.` },
  ],
  faq: [
    { q: "خرید فالوور ارزان legal است؟", a: "معمولاً بله؛ terms platform ممکن است محدود کند." },
    { q: "امن‌ترین پرداخت؟", a: "checkout رسمی panel verified." },
    { q: "چند فالوور یکجا؟", a: "relative به اندازه فعلی." },
    { q: "خرید پس از trial؟", a: "بله با retention سالم." },
    { q: "فالوور ارزان engage می‌کند؟", a: "عمدتاً social proof." },
  ],
};
